...
class Detection:
	...
	def detect(self, t):
		...
		self.companyList[symb].frequencyRegression[x].tempYVals += 1 #might delete that variable in the future
...
class PriceRegression:
	def __init__(self, numOfRegressors):
		...
		self.currCnt = 0
		self.rangeVal = 10 #to be adjusted
...
class AvgOverTimeRegression:
	def __init__(self, stepNumOfStepsPairsIndex, numOfSteps):
		...
		self.tempYVals = 0
		self.rangeVal = 10 #changed for testing
		self.coeffList = [0.0, 0.0]
